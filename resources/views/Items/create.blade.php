        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('items.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <x-forms.input label="Item Number" name="item_no" :value="old('item_no')"
                                placeholder="Enter item code" required icon="hash" :error="$errors->first('item_no')" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <x-forms.input type="number" step="0.01" label="VAT (%)" name="vat" :value="old('vat', 0)"
                                placeholder="Enter VAT percentage" icon="percent" :error="$errors->first('vat')" />
                        </div>
                        <div class="col-md-6">
                            <x-forms.input label="Unit of Measure" name="unit_of_measure"
                                :value="old('unit_of_measure', 'PCS')" placeholder="PCS, KG, etc." icon="box"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <x-forms.input label="Manufacturer Name" name="manufacturer_name"
                                :value="old('manufacturer_name')" placeholder="Enter manufacturer" icon="truck"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <x-forms.input type="number" label="Minimum Stock" name="min_stock"
                                :value="old('min_stock', 0)" placeholder="Enter minimum stock" icon="minimize"
                                :error="$errors->first('min_stock')" />
                        </div>
                        <div class="col-md-6">
                            <x-forms.input type="number" label="Maximum Stock" name="max_stock"
                                :value="old('max_stock')" placeholder="Enter maximum stock" icon="maximize"
