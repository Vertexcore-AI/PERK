...
@section('breadcrumb')
    <div class="breadcrumb-path">
        ...
        <span class="breadcrumb-current">Category Management</span>
    </div>
@endsection
                        ...
                        <tr class="group">
                            ...
                            <td>
                                @if($category->description)
                                    <span class="text-slate-600 dark:text-slate-400">{{ Str::limit($category->description, 50) }}</span>
                                @else
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    <span class="text-slate-900 dark:text-slate-100 font-medium">{{ $category->items_count ?? 0 }}</span>
                                    <span class="text-slate-500 dark:text-slate-400">items</span>
                                </div>
                            </td>
                            <td>
                                <span class="text-slate-600 dark:text-slate-400">{{ $category->created_at->format('d/m/Y H:i') }}</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-12">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-sm text-slate-500 dark:text-slate-400 mb-4">Get started by adding your first category</p>
                                    <a href="{{ route('categories.create') }}" class="btn-primary">
                                        <i data-lucide="plus" class="w-5 h-5 mr-2"></i>
                                        Add New Category
                                    </a>
