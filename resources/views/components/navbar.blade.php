    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="index.html" class="b-brand">
                ...
                <img src="assets/images/logo/Perk Enterprises.png" alt="" class="logo logo-lg"
                    style="margin: 8px; max-width: 140px; height: auto;" />
        ...
        <div class="navbar-content">
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="{{ url('/reports/stock') }}">Stock Reports</a>
                        </li>
                        <li class="nxl-item"><a class="nxl-link" href="{{ url('/reports/sales') }}">Sales Analytics</a>
                        </li>
                        <li class="nxl-item"><a class="nxl-link" href="{{ url('/reports/financial') }}">Financial
                                Reports</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="{{ url('/reports/vendors') }}">Vendor Reports</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nxl-item">
                    <a class="nxl-link" href="{{ url('/vendors') }}">
                        <span class="nxl-micon"><i data-lucide="users"></i></span>
                ...
                <li class="nxl-item">
                    <a class="nxl-link" href="{{ url('/stores') }}">
                        <span class="nxl-micon"><i data-lucide="home"></i></span>
                        <span class="nxl-mtext">Stores</span>
                    </a>
                </li>

                <li class="nxl-item">
                    <a class="nxl-link" href="{{ url('/bins') }}">
                        <span class="nxl-micon"><i data-lucide="archive"></i></span>
                        <span class="nxl-mtext">Bins</span>
                    </a>
                </li>
