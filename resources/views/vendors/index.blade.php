...
<div class="flex items-center gap-3">
    ...
    <a href="{{ route('vendorcsv.exprot') }}" class="btn-secondary">
        ...
        <table class="table-modern w-full">
            ...
            <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                ...
                <tr class="group">
                    ...
                    <td>
                        ...
                        <div>
                            ...
                            <span class="block text-xs text-slate-500 dark:text-slate-400 mt-1">{{
                                Str::limit($vendor->address, 30) }}</span>
                            @endif
                        </div>
                        @else
                    ...
                    <td>
                        <span class="text-slate-600 dark:text-slate-400">{{ $vendor->created_at->format('d/m/Y H:i')
                            }}</span>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="flex items-center justify-end gap-1">
                            <a href="{{ route('vendors.edit', $vendor) }}" class="btn-icon group/btn"
                            ...
                            <form action="{{ route('vendors.destroy', $vendor) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-icon group/btn" data-tooltip="Delete Vendor"
                    ...
                    <td colspan="5" class="text-center py-12">
                        <div class="flex flex-col items-center justify-center">
                            <div
                                ...
                                <i data-lucide="building" class="w-10 h-10 text-slate-400 dark:text-slate-500"></i>
                            </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ $vendors->previousPageUrl() }}"
                    class="px-3 py-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400 transition-colors">
                    <i data-lucide="chevron-left" class="w-5 h-5"></i>
                </a>
                @endif
