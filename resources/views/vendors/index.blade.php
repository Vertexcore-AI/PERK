                            ...
                            <tr>
                                ...
                                <td>
                                    @if($vendor->contact)
                                        ...
                                        @if($vendor->address)
                                            <span class="fs-12 d-block fw-normal text-muted">{{ Str::limit($vendor->address, 30) }}</span>
                                        @endif
                                    @else
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="{{ route('vendors.edit', $vendor) }}" data-bs-toggle="tooltip" title="Edit Vendor"><i data-lucide="edit" style="width: 14px; height: 14px;"></i></a>
                                        <form action="{{ route('vendors.destroy', $vendor) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" data-bs-toggle="tooltip" title="Delete Vendor" onclick="return confirm('Are you sure you want to delete this vendor?')"><i data-lucide="trash-2" style="width: 14px; height: 14px;"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="empty-state">
                                        ...
                                        <span class="fs-12 d-block fw-normal text-muted mb-3">Get started by adding your first vendor</span>
