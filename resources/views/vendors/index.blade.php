                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                    @forelse($vendors as $vendor)
                        <tr class="group">
                            <td>
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-gradient-to-br from-primary-400 to-primary-600 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/25 group-hover:scale-110 transition-transform">
                                        <span class="text-white font-semibold">{{ strtoupper(substr($vendor->name, 0, 1)) }}</span>
                                    </div>
                                    <div>
