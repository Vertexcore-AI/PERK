        ...
        <div class="grn-item border border-slate-200 dark:border-slate-700 rounded-xl p-6 mb-6 bg-white dark:bg-slate-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Purchase cost per unit</p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number"
                            ...
                            class="pl-8 w-full px-4 py-2.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent selling-price"
                            step="0.01"
                            min="0"
                            placeholder="0.00"
                            required>
                    </div>
                    <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Intended selling price per unit</p>
                </div>
                    ...
                    <div class="bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-xl p-4 border border-primary-200 dark:border-primary-800">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="flex justify-between items-center">
                                <span class="text-sm font-medium text-primary-700 dark:text-primary-300">Unit Cost:</span>
                                <span class="text-base font-bold text-primary-900 dark:text-primary-100">$<span class="unit-cost-display">0.00</span></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm font-medium text-primary-700 dark:text-primary-300">Selling Price:</span>
                                <span class="text-base font-bold text-primary-900 dark:text-primary-100">$<span class="selling-price-display">0.00</span></span>
                            </div>
                            <div class="flex justify-between items-center">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function showImportResults(data) {
            ...
            const canFinalize = data.stats.unresolved === 0 && data.stats.suggestions === 0;
                ...
                contentHtml += `
                    <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4 mb-4">
                        <h5 class="font-medium text-green-800 dark:text-green-300 mb-2">
                            ...
                            ${data.stats.resolved} items ready to import
                        </h5>
                        <p class="text-sm text-green-700 dark:text-green-400">All items have been successfully mapped and are ready for import.</p>
                    </div>
                `;
            }
            ...
            if (data.data.suggestions && data.data.suggestions.length > 0) {
                ...
                data.data.suggestions.forEach((item, index) => {
                    ...
                    contentHtml += `
                                ...
                                <label class="flex items-center p-2 border border-slate-200 dark:border-slate-600 rounded cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-600">
                                    <input type="radio" name="suggestion_${index}" value="skip" class="mr-3">
                                    <div class="flex-1">
                                        <span class="font-medium text-red-600 dark:text-red-400">Skip this item</span>
                                        <div class="text-sm text-slate-600 dark:text-slate-400">Don't import this item</div>
                                    </div>
                                </label>
                            </div>
                        </div>
                    ...
                    contentHtml += `
                        <div class="bg-white dark:bg-slate-700 border border-red-200 dark:border-red-700 rounded-lg p-4">
                            ...
                            <div class="space-y-2 mt-3">
                                ...
                                <label class="flex items-center p-2 border border-slate-200 dark:border-slate-600 rounded cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-600">
                                    <input type="radio" name="unresolved_${index}" value="create_new" class="mr-3">
                                    <div class="flex-1">
                                        <span class="font-medium text-blue-600 dark:text-blue-400">Create new item</span>
                                        <div class="text-sm text-slate-600 dark:text-slate-400">Create a new item with this description</div>
                                    </div>
                                ...
                                <label class="flex items-center p-2 border border-slate-200 dark:border-slate-600 rounded cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-600">
                                    <input type="radio" name="unresolved_${index}" value="skip" class="mr-3">
                                    <div class="flex-1">
                                        <span class="font-medium text-red-600 dark:text-red-400">Skip this item</span>
                                        <div class="text-sm text-slate-600 dark:text-slate-400">Don't import this item</div>
                                    </div>
        ...
        function applyResolutions() {
            ...
            Object.entries(suggestionGroups).forEach(([index, action]) => {
                resolutionsToProcess.push({
                    ...
                    itemId: action !== 'skip' && action !== 'create_new' ? action : null
                });
            });
