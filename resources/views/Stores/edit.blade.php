        ...
        <div class="card">
            <div class="card-header border-bottom">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Update store details below</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('stores.update', $store) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <x-forms.input label="Store Name" name="store_name"
                                :value="old('store_name', $store->store_name)" placeholder="Enter store name" required
                                icon="home" :error="$errors->first('store_name')" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <x-forms.input label="Store Location" name="store_location"
                                :value="old('store_location', $store->store_location)"
                                placeholder="Enter store location" icon="map-pin"
